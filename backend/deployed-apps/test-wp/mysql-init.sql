...
('siteurl', 'http://localhost:9359', 'yes'),
('home', 'http://localhost:9359', 'yes'),
('blogname', 'test-wp', 'yes'),
('blogdescription', 'Un sitio increíble', 'yes'),
...
('fresh_site', '1', 'yes'),
('WPLANG', 'es_ES', 'yes'),
('new_admin_email', 'admin@example.com', 'yes');
